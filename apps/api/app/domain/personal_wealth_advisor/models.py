...
class AgenticPersonalWealthAdvisorSession(Base):
    __tablename__ = "personal_wealth_advisor_sessions"
...
class AgenticPersonalWealthAdvisorItem(Base):
    __tablename__ = "personal_wealth_advisor_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("personal_wealth_advisor_sessions.id"))
