...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic AI Personal Wealth & Tax Strategy Advisor</h1>
      <p style={{ color: '#666' }}>Multi-agent personal finance management, tax optimization planner, expense categorization, and retirement forecaster.</p>
